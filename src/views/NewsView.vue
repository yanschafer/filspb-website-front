<template>
  <!-- ааауаыыыы -->
  <HeaderComponent />
  <PageHeaderComponent :utils="false" class="animate__animated animate__fadeIn" title="Новости" imgSrc="/CircleImages/13.png" />
  <NewsGrid 
    :news="news" 
    :is-news-page="true"
...
export default {
  ...
  async created() {
    ...
    this.news = (await newsModel.getAll()).getData()
  }
};
</script>
